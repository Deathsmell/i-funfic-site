...
import {
    ...
    SET_ADMIN_ROLE_URL,
    UNBLOCK_USER_URL, UPDATE_USER_IMAGE,
    UPDATE_USER_PROFILE
} from "@api"
...
export const AdminApi = {
    ...
    updateUserImage: async (id: number | string, image: string): IFetchResponse<IResponse> =>
        await axiosInstance.post(UPDATE_USER_IMAGE, {id, image}),
}
